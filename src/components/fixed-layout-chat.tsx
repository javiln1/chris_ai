...
export default function FixedLayoutChat() {
  ...
  return (
    <div className="flex h-screen bg-custom-dark">
      ...
      <motion.div
        ...
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-custom-dark-secondary transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-b border-border">
            ...
            <button
              ...
              className="w-full bg-primary hover:bg-accent text-black px-4 py-2 rounded-md transition-colors"
            >
              New Chat
            </button>
          </div>
      ...
      <main className="flex-1 flex flex-col">
        {/* Header */}
        <header className="flex items-center justify-between p-4 border-b border-border bg-custom-dark">
          ...
          <div className="flex items-center space-x-3">
            <motion.button
              ...
              className="p-2 hover:bg-custom-dark-secondary rounded-md transition-colors cursor-pointer"
            >
              <div className="space-y-1">
                <div className="w-5 h-0.5 bg-text-secondary"></div>
                <div className="w-5 h-0.5 bg-text-secondary"></div>
                <div className="w-5 h-0.5 bg-text-secondary"></div>
              </div>
            </motion.button>
        ...
        {/* Input Area */}
        <div className="border-t border-border p-4 bg-custom-dark">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative" ref={fileMenuRef}>
                <motion.button
                  ...
                  className="bg-custom-dark-tertiary hover:bg-custom-dark rounded-full p-2 transition-colors"
                >
                  <svg className="w-4 h-4 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-custom-dark-secondary border border-border rounded-lg text-text placeholder-text-secondary focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent pr-20"
                  disabled={isLoading}
                />
              ...
              <motion.button
                ...
                className="bg-primary hover:bg-accent disabled:opacity-50 disabled:cursor-not-allowed text-black p-3 rounded-lg transition-colors"
              >
                <motion.svg 
                  className="w-5 h-5" 
                  fill="none" 
