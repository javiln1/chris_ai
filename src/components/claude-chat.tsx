            ...
            <AnimatePresence>
              {isDropdownOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  transition={{ duration: 0.2 }}
                  className="absolute right-0 mt-2 w-64 bg-custom-dark-secondary border border-border rounded-lg shadow-lg z-50"
                >
                      ...
                      <motion.button
                        ...
                        className={`w-full flex items-center space-x-3 p-3 rounded-lg text-left transition-all duration-200 ${
                          selectedAgent === agent.id 
                            ? 'bg-custom-dark-tertiary border border-accent/30' 
