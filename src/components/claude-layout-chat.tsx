                            ...
                            <AnimatePresence>
                              {isConnectorsMenuOpen && (
                                <motion.div
                                  ...
                                  animate={{ opacity: 1, y: 0 }}
                                  exit={{ opacity: 0, y: 10 }}
                                  className="absolute bottom-full left-0 mb-2 bg-custom-dark-secondary border border-border rounded-lg shadow-lg p-2 space-y-1 w-64"
                                >
                                  <div className="flex items-center justify-between p-2 hover:bg-custom-dark-tertiary rounded cursor-pointer">
                                    <div className="flex items-center gap-3">
                                      <svg className="w-4 h-4 text-text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <div className="flex items-center justify-between p-2 hover:bg-custom-dark-tertiary rounded cursor-pointer">
                                    ...
                                    <ToggleSwitch 
                                      enabled={enabledConnectors['drive-search']} 
                                      onChange={() => toggleConnector('drive-search')} 
                                    />
                                  </div>
                                  ...
                                  <div className="flex items-center justify-between p-2 hover:bg-custom-dark-tertiary rounded cursor-pointer">
                                    <div className="flex items-center gap-3">
                                      ...
                                      <span className="text-sm text-text">Gmail</span>
                                    </div>
                                    <ToggleSwitch 
                                      enabled={enabledConnectors['gmail']} 
                                      onChange={() => toggleConnector('gmail')} 
